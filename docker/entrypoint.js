...
const bookPrepWebSearchModel = resolveSetting('BOOK_PREP_WEB_SEARCH_MODEL', 'gpt-4o-mini', ['BOOK_PREP_WEB_SEARCH_MODEL', 'book_prep_web_search_model'])
...
process.env.BOOK_PREP_WEB_SEARCH_MODEL = String(bookPrepWebSearchModel ?? 'gpt-4o-mini')
